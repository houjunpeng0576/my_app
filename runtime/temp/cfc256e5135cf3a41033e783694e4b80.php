<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"D:\wamp\www\demo\htdocs\project\public/../application/admin\view\login\index.html";i:1512842456;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
    ...
    <![endif]-->
    <link href="__STATIC__/hui_admin/static/h-ui/css/H-ui.min.css" rel="stylesheet" type="text/css" />
    <link href="__STATIC__/hui_admin/static/h-ui.admin/css/H-ui.login.css" rel="stylesheet" type="text/css" />
    <link href="__STATIC__/hui_admin/static/h-ui.admin/css/style.css" rel="stylesheet" type="text/css" />
    <link href="__STATIC__/hui_admin/lib/Hui-iconfont/1.0.8/iconfont.css" rel="stylesheet" type="text/css" />
    <!--[if IE 6]>
        ...
        <form class="form form-horizontal" action="<?php echo url('Login/check'); ?>" method="post">
            ...
            <div class="row cl">
                <div class="formControls col-xs-8 col-xs-offset-3">
                    ...
                    <img src="/index.php/captcha" alt="点击更新验证码" onclick="reloadcode(this)"> <!--<a id="kanbuq" href="javascript:;">看不清，换一张</a> --></div>
            </div>
            <!--<div class="row cl">
                <div class="formControls col-xs-8 col-xs-offset-3">
                    <label for="online">
